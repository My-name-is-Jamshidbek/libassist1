...
class Book(models.Model):
    ...
    key = models.CharField(max_length=25, verbose_name='Инвентар рақами', unique=True)
    ...
    def __str__(self):
        return self.book_name[:50]


class NfcCheck(models.Model):
    student = models.ForeignKey(Students, on_delete=models.CASCADE, related_name='nfc_check')
    staff = models.CharField(max_length=100, verbose_name='Bergan odam nomi')
    created = models.DateTimeField(editable=False, auto_now_add=True)
    book_name = models.CharField(max_length=50, verbose_name="Kitob nomi")
    author = models.CharField(max_length=100, verbose_name='Муаллифи')
